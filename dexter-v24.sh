...
# Your SSH Banner
SSH_Banner='SSH_Banner='http://script.psytech-vpn.com/DexterEskalarte/sshsslovpn_ws/SshBanner''
...
#############################
 ...
 echo -e "\033[0;35mInstalling Websocket/Ovpn Service...\033[0m"
  fun_bar gatorade1
 
 # BBR
 echo -e "\033[0;35mInstalling BBR...\033[0m"
  fun_bar BBR
...
systemctl restart openvpn
 ...
 echo -e " OpenVPN/TCP: $OpenVPN_Port1,$OpenVPN_Port3"
